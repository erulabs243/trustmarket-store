<script lang="ts">
    import { IconBrandInstagram, IconBrandTelegram, IconBrandWhatsapp, IconBrandYoutube, IconMail } from "@tabler/icons-svelte";
...
<footer class="footer p-10 w-screen lg:w-5/6 mx-auto bg-base-200 text-base-content">
  <aside class="items-center grid-flow-col">
    ...
    <p><span class="text-lg text-secondary">TrustMarket</span> <br/>Achetez plus simplement</p>
  </aside> 
  <nav>
    <header class="footer-title">Liens utiles</header>
    <a class="link link-hover" href="/">Accueil</a>
    <a class="link link-hover" href="/store/categories">Catégories</a>
    <a class="link link-hover" href="/store/collections">Collections</a>
  </nav>
  <nav>
...
<footer class="footer px-10 py-4 border-t bg-base-200 items-center text-base-content border-base-300 w-screen lg:w-5/6 mx-auto">
