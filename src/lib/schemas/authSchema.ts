...
export const registrationSchema = z.object({
	email: z.string().trim().min(1, "Adresse e-mail obligatoire").email("Adresse e-mail invalide"),
	...
	password: z.string().trim().min(1, "Mot de passe obligatoire").refine(validator.isStrongPassword),
});